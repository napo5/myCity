...
public class Worker extends Citizen {
    ...
    private ArrayList<Task> tasksInCharge = new ArrayList<>();
    ...
    public void addTaskInCharge(Task task) {
        this.tasksInCharge.add(task);
    }
    ...
    public void acceptTask() throws NumberFormatException, IOException {
        ...
        for (Task task : this.confirmRequest) {
            ...
            addTaskInCharge(task);
            task.getReport().setState(ReportState.WORK_IN_PROGRESS);
        }
    }
    ...
    public void confirmTaskDone() {
       // TODO print tasksInCharge list and scan for a selection
        Task selectedTask = new Task();
        selectedTask.setState(TaskState.WAITING_FOR_CONFIRMS);
    }
